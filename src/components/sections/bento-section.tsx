...
const BentoSection = () => {
  ...
  return (
    <section
      id="bento"
      className="flex flex-col items-center justify-center w-full relative px-6 md:px-12 lg:px-20 py-12 border-t border-border"
    >
